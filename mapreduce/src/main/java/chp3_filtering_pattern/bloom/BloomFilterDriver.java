package chp3_filtering_pattern.bloom;
...
/**
 * Problem: Given a list of user’s comments, filter out a majority of the
 * comments that do not contain a particular keyword.
 * 
 * @author Alex
 *
 */
